      ...
      <div class="left">
        ...
        <div class="panel">
          ...
          <div class="quick-entry">
            <router-link to="/approval" class="entry-item">
              <div class="entry-icon approval" />
              <span>假期审批</span>
            </router-link>
            <router-link to="/social" class="entry-item">
              <div class="entry-icon social" />
              <span>社保管理</span>
            </router-link>

            <router-link to="/role" class="entry-item">
              <div class="entry-icon role" />
              <span>角色管理</span>
            </router-link>

            <router-link to="/salary" class="entry-item">
              <div class="entry-icon salary" />
              <span>薪资设置</span>
            </router-link>

            <router-link to="/permission" class="entry-item">
